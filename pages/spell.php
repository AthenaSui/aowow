    ...
    protected function generateContent()
    {
        ...
        if ($this->subject->getSources($s) && in_array(SRC_TRAINER, $s))
        {
            $trainers = DB::World()->select('
                SELECT  IF(t1.ID > 200000, t2.ID, t1.ID) AS ARRAY_KEY, t1.ReqSkillLine AS reqSkillId, t1.ReqSkillRank AS reqSkillValue, t1.ReqLevel AS reqLevel, t1.ReqSpell AS reqSpellId1, 0 AS reqSpellId2
                FROM    npc_trainer t1
