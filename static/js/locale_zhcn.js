...
var LANG = {
    ...
    tooltip_arenapoints:               "竞技场点数", // enUS
    ...
    traits: {
        ...
        mlecritstrkrtng:    ["近战爆击等级", "近战爆击", "爆击"],
        mledmgmax:          ["近战最大伤害", "近战最大伤害", "最大"],
        mledmgmin:          ["近战最小伤害", "近战最小伤害", "最小"],
        mledps:             ["近战DPS", "近战DPS", "DPS"],
        mlehastertng:       ["近战急速等级", "近战急速", "急速"],
        mlehitrtng:         ["近战命中等级", "近战命中", "命中等级"],
        mlespeed:           ["近战速度", "近战速度", "速度"],
        natres:             ["自然抗性", "自然抗性", "自然抗"],
        ...
        rgdcritstrkrtng:    ["远程爆击等级", "远程爆击", "爆击"],
        rgddmgmax:          ["远程最大伤害", "远程最大伤害", "最大"],
        rgddmgmin:          ["远程最小伤害", "远程最小伤害", "分钟"],
        rgddps:             ["远程DPS", "远程DPS", "DPS"],
        rgdhastertng:       ["远程急速等级", "远程急速", "急速"],
        rgdhitrtng:         ["远程命中等级", "远程命中", "命中等级"],
        rgdspeed:           ["远程速度", "远程速度", "速度"],
        sellprice:          ["售价（铜）", "售价", "售价"], // enUS
        sepbasestats:       "基本属性",
        ...
        sepweaponstats:     "武器状态",
        shares:             ["暗影抗性", "暗影抗性", "暗抗"],
        shasplpwr:          ["暗影法术强度", "暗影能量", "暗伤"],
        speed:              ["速度", "速度", "速度"],
        spi:                ["精神", "精神", "精神"],
        splcritstrkrtng:    ["法术爆击等级", "法术爆击", "爆击"],
        spldmg:             ["法术伤害", "法术伤害", "法伤"],
        splheal:            ["法术治疗", "法术治疗", "治疗"],
        splpwr:             ["法术强度", "法术强度", "法强"],
    ...
    fiitems: {
        ...
        purchasablewithhonor:    "可用荣誉点数购买", // enUS
        purchasablewitharena:    "可用竞技场点数购买", // enUS
    ...
    pr_purgedata:  "单击可删除当前选项卡中的所有已完成数据。<br />只有上传了数据的用户才能清除数据。", // enUS
    ...
    pr_stats_mlecritstrkpct: "爆击率",
    pr_stats_mlehastepct:    "速度",
    pr_stats_mlehitpct:      "命中等级",
    ...
    pr_stats_rgdcritstrkpct: "爆击率",
    pr_stats_rgdhastepct:    "加速",
    pr_stats_rgdhitpct:      "命中等级",
    pr_stats_runic:          "符文能量",
    pr_stats_shares:         "暗影抗性",
    pr_stats_spi:            "精神",
    pr_stats_splcritstrkpct: "爆击率",
    pr_stats_spldmg:         "伤害加成",
    pr_stats_splhastepct:    "急速等级",
    pr_stats_splheal:        "治疗加成",
    pr_stats_splhitpct:      "命中等级",
    pr_stats_splpen:         "穿透",
    pr_stats_sta:            "耐力",
    pr_stats_str:            "力量",
    ...
    pr_statstt_agi:"攻击强度提高$1点<br />爆击击率提高$2%<br />护甲值提高$3点",
    pr_statstt_armor:"受到的物理伤害减免$2%",
    pr_statstt_armor2:"受到的物理伤害减免$2%<br />使你的宠物的护甲值提高$1点",
    pr_statstt_armorpenpct:'<span class="q2">护甲穿透等级$1（+$2% 护甲穿透）</span><br />敌方目标护甲值降低最多$3%',
    pr_statstt_blockpct:'<span class="q2">格挡等级 $1 (+$2% 格挡几率)</span><br />使格挡几率提高$4%<br />格挡抵消$3点伤害。',
    pr_statstt_def:'<span class="q2">防御等级 $1 (+$2 防御)</span><br />躲闪，格挡和招架的几率提高$3%<br />被命中和被爆击的几率降低$4%（在效果递减之前）',
    pr_statstt_dodgepct:'<span class="q2">躲闪等级 $1 (+$2% 躲闪几率)</span><br />使你的躲闪几率提高$3%（在效果递减之前）<br />',
    pr_statstt_exp:'<span class="q2">精准等级 $1 (+$2 精准)</span><br />被躲闪或招架几率降低$3%',
    pr_statstt_int:"法力值提高$1点<br />法术爆击几率提高$2%",
    pr_statstt_int2:"法力值提高$1点<br />法术爆击几率提高$2%<br />使你的宠物的智力值提高$3点",
    pr_statstt_mleatkpwr:"使近战武器的每秒伤害提高$1。",
    pr_statstt_mlecritstrkpct:'<span class="q2">爆击等级$1（+$2% 爆击几率)</span><br />物理爆击几率 $3%',
    pr_statstt_mlehastepct:'<span class="q2">急速等级$1 ($2% 加速)</span><br />攻击速度提高$3%',
    pr_statstt_mlehitpct:'<span class="q2">近战命中等级提高$1（+$2%命中几率）</span><br />使你的近战攻击命中$4级目标的几率提高$3%',
    pr_statstt_oocmanargn:"非施法状态下每5秒恢复$1点法力值<br />施法状态下每5秒恢复$2点法力值",
    pr_statstt_parrypct:'<span class="q2">招架等级 $1 (+$2% 招架几率)</span><br />使招架几率提高$3%（在效果递减之前）',
    pr_statstt_resipct:'<span class="q2">韧性等级 $1 (+$2% 韧性)</span><br />使敌人对你造成爆击的几率降低$3%<br />使法力吸取效果和受到爆击时承受的伤害降低$4%<br />使玩家和他们的宠物或奴仆对你造成的所有伤害降低额外$5%',
    pr_statstt_resist:"提高针对$1伤害的抗性。<br />对等级$3的目标 平均法术抵挡: $1%",
    pr_statstt_rgdatkpwr:"使远程武器的每秒伤害提高$1。",
    pr_statstt_rgdatkpwr2:"使远程武器的每秒伤害提高$。1<br />使你的宠物的攻击强度提高$2点<br />使你的宠物的法术伤害提高$3点",
    pr_statstt_rgdcritstrkpct:'<span class="q2">爆击等级$1 (+$2% 爆击几率)</span><br />远程武器的爆击几率 $3%',
    pr_statstt_rgdhastepct:'<span class="q2">急速等级$1 ($2% 加速)</span><br />攻击速度提高$3%',
    pr_statstt_rgdhitpct:'<span class="q2">命中等级 $1 (+$2% 命中几率)</span><br />使你的远程攻击命中$4级目标的几率提高$3%',
    pr_statstt_spi:"在非战斗状态下，使你的生命值恢复速度提高每秒$1点<br />在非施法状态下时，每5秒的法力值恢复量提高$2点",
    pr_statstt_splcritstrkpct:'<span class="q2">爆击等级$2 (+$3% 爆击几率)</span><br />$1',
    pr_statstt_spldmg:"$1",
    pr_statstt_spldmg2:"$1<br />使你的宠物的攻击强度提高$3点<br />使你的宠物的法术伤害提高$4点",
    pr_statstt_splhastepct:'<span class="q2">急速等级$1 (+$2% 急速)</span><br />使你的施法速度提高$3%',
    pr_statstt_splheal:"使你的治疗效果提高最多$1点",
    pr_statstt_splhitpct:'<span class="q2">命中等级$1 (+$2% 命中几率)</span><br />使你的法术命中$4级目标的几率提高$3%',
    pr_statstt_splpen:'<span class="q2">法术穿透</span><br />降低目标抗性$1点',
    pr_statstt_sta:"生命值提高$1点",
    pr_statstt_sta2:"生命值提高$1点<br />使你的宠物的耐力提高$2点",
    pr_statstt_str:"攻击强度提高$1点",
    pr_statstt_str2:"攻击强度提高$1点<br />格挡值提高$2",
    ...
    descriptionlengthlong_tip:          '你的描述超出了$1个字！可能会被删减哦。',
